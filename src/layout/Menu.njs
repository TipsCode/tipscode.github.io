        ...
        <header class="fixed w-full bg-white top-0 left-0 z-50 h-20">
          <div class="max-w-screen-xl mx-auto px-4 flex justify-between items-center flex-wrap py-4">
            ...
            >
              ...
              <Link href="https://go.hotmart.com/A43229044U?src=blog" onclick={{ expanded: false }} classCustome="bg-tips-blue text-white px-3 py-2 border border-tips-blue rounded hover:bg-white hover:text-tips-blue w-full sm:w-auto"> Full-Stack Turbo</Link>
            </div>
          </div>
        </header>
        <div class="h-20" />
