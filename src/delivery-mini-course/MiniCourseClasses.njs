          ...
          <div class="md:flex md:justify-around">
            ...
            <aside>
              <ul class="divide-y-2 divide-gray-100">
                <li class="p-3 hover:bg-blue-600 hover:text-blue-200 cursor-pointer" onclick={this.mudar1}>Aula 01</li>
                <li class="p-3 hover:bg-blue-600 hover:text-blue-200 cursor-pointer" onclick={this.mudar2}>Aula 02</li>
                <li class="p-3 hover:bg-blue-600 hover:text-blue-200 cursor-pointer" onclick={this.mudar3}>Aula 03</li>
                <li class="p-3 hover:bg-blue-600 hover:text-blue-200 cursor-pointer" onclick={this.mudar4}>Aula 04</li>
                <li class="p-3 hover:bg-blue-600 hover:text-blue-200 cursor-pointer" onclick={this.mudar5}>Aula 05</li>
                <li class="p-3 hover:bg-blue-600 hover:text-blue-200 cursor-pointer" onclick={this.mudar6}>Aula 06</li>
              </ul>
            </aside>
          </div>
