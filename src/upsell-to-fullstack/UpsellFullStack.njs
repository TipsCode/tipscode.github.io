  ...
  render() {
    return (
      ...
      <section class="bg-zing w-full h-full text-white text-center ">
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-center mt-0 py-2">
          ...
          <div class="">
            <a class="lg:pt-16 toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
              <img src="/TipsCodelogo.png" alt="TipsCode" loading="lazy" width="206" height="86" />
            </a>
        ...
        <div class="textContainerHeader">
         <h1 class="title" >
            <span>Obrigado</span> <br></br>
            Não posso deixar você ir..<br />
            Eu estaria sendo injusto se deixasse você perder essa oportunidade...
        ...
        <div class="siteText">
          ...
          <div class="containerSectionText">
            ...
            <div class="textDivp">
              <p>
                ...
                O seu <span class="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-500 to-indigo-600">preço atual é 297,00</span>  mas porque você adquiriu o curso de react, você vai
                levar a formação full stack <br />por apenas

                <div class="contentValor">
                  <div>
                    <span class="textDePor">de R$297,00</span>
                  </div>
                  <p class="textValorCurso">Por apenas <span>R$197,00</span></p>
                </div>
              </p>
            </div>

            <div class="textDivp">
              <p class="mt-5 prose max-w-none text-white">  Isso mesmo que você está lendo, apenas R$197,00! Este treinamento vai complementar o curso de react,
            ...
            <div class="flex justify-center marginHotmart">
