    ...
    <>
      <section class="bg-hero-python text-center text-white">
        <div class="relative min-[700px]:mb-24 min-[700px] flex flex-col items-center gap-y-10">
          ...
          <a class="mb-8 bg-[#5FE2FF] min-[700px]:mb-60 py-2 min-[700px]:py-3 px-4 min-[700px]:px-6 min-[700px]:text-2xl min-[700px]:font-medium rounded-[30px] text-black" href="/pre-cadastro-python">Garantir minha vaga!</a>
