                ...
                <section class="container mx-auto text-center py-6 mb-12">
                    ...
                    <div class="mx-auto py-12 flex flex-wrap justify-center">
                        <div class="">
                            ...
                            <h3 class="my-4 text-4xl leading-tight text-green-400 font-bold">
                                12x  R$41,41
                            </h3>
                    ...
                    <button
                        class="mx-auto lg:mx-0 hover:underline bg-green-400 text-white font-bold rounded-md my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
