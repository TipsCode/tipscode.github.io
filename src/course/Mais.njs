                ...
                <section class="bg-tips-dark py-8 tracking-wide">
                    <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
                        ...
                        <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4 relative ">
                            ...
                            <div
                                class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg  mt-4 z-50 bg-tips-gray-dark bg-opacity-90">
                                <div
                            ...
                            <div
                                class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 mt-4 pb-20 z-50 bg-tips-gray-dark bg-opacity-90">
                                <div
                                    class="flex-1  text-white rounded-t rounded-b-none overflow-hidden px-5 ">
                            ...
                            <div
                                class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-none lg:rounded-r-lg bg-tips-gray-dark bg-opacity-90 mt-4 z-50">
                                <div
                                    class="flex-1  text-white rounded-t rounded-b-none overflow-hidden px-5">
