...
class Mais extends Nullstack {
    render() {
        return (
            <div>
                <section class="bg-tips-dark py-8 tracking-wide">
                    <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
                        <h1
                            class="w-full mt-2 mb-20 text-3xl lg:text-5xl font-bold leading-tight text-center text-white">
                            Mais
                        </h1>
                        
                        <div class="flex flex-col lg:flex-row justify-center pt-12 my-12 sm:my-4 relative ">
                        ...
                        <div class="w-full justify-center items-center">
                            <h4 class="w-full mt-32 mb-12 text-2xl lg:text-3xl font-bold leading-tight text-center text-white">Entre para o seleto hall de alunos do TipsCode e conquiste as melhores oportunidades do mercado</h4>
