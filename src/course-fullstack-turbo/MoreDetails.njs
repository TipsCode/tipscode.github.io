      ...
      <section class="md:py-8 tracking-wide">
        <div class="container mx-auto px-2  text-gray-800">
          ...
          <div class="flex flex-col lg:flex-row justify-center pt-12 my-4 md:my-12 relative">
            ...
            <CardMoreDetails
              src="/sales-page-img/card-more-details/Heroku-bubble.webp"
              alt="Heroku"
              contentDiv="Heroku"
              contentP="Com o Heroku você será capaz com apenas 3 cliques colocar uma
aplicação / site no ar, para todos verem o seu projeto."
            />

            <CardMoreDetails
              src="/sales-page-img/card-more-details/Security-bubble.webp"
              alt="Segurança e autenticação"
              contentDiv="Segurança e autenticação"
              contentP="Você aprenderá técnicas de segurança e proteção dos dados da
