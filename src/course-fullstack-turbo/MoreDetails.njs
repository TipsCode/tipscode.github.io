          ...
          <div class="container mx-auto px-2 md:pt-4 pb-12 text-gray-800">
            ...
            <div class="w-full justify-center items-center">
              ...
              <div class="flex w-full justify-center items-center my-0">
                <a href={hotmartLink} class="mx-auto z-50 self-center lg:mx-0 bg-tips-green text-white font-bold rounded-md md:my-6 py-2 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                  Quero ser fullstack
                </a>
              </div>
            </div>
