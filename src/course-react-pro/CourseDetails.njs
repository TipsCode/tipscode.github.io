  ...
  return (
    <section>
      <div class="container px-5 py-12 mx-auto lg:px-20">
        ...
        <div
          class="flex flex-wrap items-end justify-start w-full mt-10 transition duration-500 ease-in-out transform  border-2 border-gray-600 rounded-lg hover:border-white "
        >
          <div class="w-full xl:w-1/4 md:w-1/4">
            <div class="relative flex flex-col h-full p-8 ">
              ...
              <p class="flex items-center mb-2 text-lg font-normal tracking-wide text-white">
                ...
                </span>Projetos para o seu portfólio.
              </p>
            </div>
          </div>
          <div class="w-full xl:w-1/4 md:w-1/4">
            <div class="relative flex flex-col h-full p-8 ">
              ...
              <p class="flex items-center mb-2 text-lg font-normal tracking-wide text-white">
                ...
                </span>Suporte direto com Professor.
              </p>
              <p class="flex items-center mb-2 text-lg font-normal tracking-wide text-white">
                <span
                  class="inline-flex items-center justify-center flex-shrink-0 w-5 h-5 mr-2 text-white rounded-full bg-blue-1300"
          ...
          <div class="w-full xl:w-1/4 md:w-1/4 lg:ml-auto">
            <div class="relative flex flex-col h-full p-8">
              ...
              <a
                href="https://pay.hotmart.com/F68520890I?off=hazld3th&checkoutMode=10"
      ...
      <a
        href="http://wickedtemplates.com/?ref=codepen"
        target="_blank"
